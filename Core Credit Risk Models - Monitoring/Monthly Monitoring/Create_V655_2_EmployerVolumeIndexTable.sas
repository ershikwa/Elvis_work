...
proc sql;
	create table EmployerVolumeIndex_V665 as
...
%Upload_APS(Set = EmployerVolumeIndex_V665 , Server =Work, APS_ODBC = PRD_DaDi, APS_DB = PRD_DataDistillery , distribute = HASH([employersubgroupcode]));
