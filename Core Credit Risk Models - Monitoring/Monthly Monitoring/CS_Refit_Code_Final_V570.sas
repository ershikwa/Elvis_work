...
%let directory = "\\mpwsas64\Core_Credit_Risk_Models\V5\CS_Refit_V570\Refit_&previous_month.";
%let main_dataset = "\\mpwsas64\Core_Credit_Risk_Models\V5\V5 Monitoring\Performance Monitoring\Compuscan Monitoring\V570\disbursedbase.sas7bdat";
...
%createdirectory(directory=\\mpwsas64\Core_Credit_Risk_Models\V5\CS_Refit_V570\Refit_&previous_month.);
options noxwait;
%macro loop();
	%do i = 1 %to 5;
		%let programtocopy=\\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V570 CS_Refit\CS_Refit_seg.sas;
		%let segmentno =   \\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V570 CS_Refit\CS_Refit_seg&i..sas;
		%let programpath = \\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V570 CS_Refit;
	...
	%let tableexist=0;
	libname data "\\mpwsas64\Core_Credit_Risk_Models\V5\CS_Refit_V570\Refit_&previous_month";
