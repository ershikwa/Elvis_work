...
%let path = \\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V580 TU_Refit;
libname data3M_&p. "\\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V580 TU_Refit\TU_Refit_&lst3mnths.\Segment&p.";
libname data2M_&p. "\\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V580 TU_Refit\TU_Refit_&lst2mnths.\Segment&p.";
libname data1M_&p. "\\mpwsas64\Core_Credit_Risk_Models\V5\Application Scorecard\V6 Monitoring\V580 TU_Refit\TU_Refit_&lstmnth.\Segment&p.";
...
libname iv " \\mpwsas64\Core_Credit_Risk_Model_Team\Scorecard\V580 TU\V580 TU\Segment&p.\IV";

proc sql;
	select tranwrd(effect,"_W","") into : varlist separated by " " 
	from IV._ESTIMATES_
	where upcase(effect) ne "INTERCEPT"
;
quit;
